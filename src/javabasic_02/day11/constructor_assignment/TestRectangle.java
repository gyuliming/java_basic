package javabasic_02.day11.constructor_assignment;
...
public class TestRectangle {
	public static void main(String s[]){
		...
		else if (rec1.area() < rec2.area()) System.out.println("넓이는 " + rec2.getColor() + " 직사각형이 더 큽니다.");
		...
		else if (rec1.perimeter() < rec2.perimeter()) System.out.println("둘레는 " + rec2.getColor() + " 직사각형이 더 깁니다.");
