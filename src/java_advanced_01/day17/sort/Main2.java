package java_advanced_01.day17.sort;
    ...
    public static void main(String[] args) {
        ...
        Arrays.sort(users, new Comparator<User>() {
            ...
            public int compare(User o1, User o2) {
                return Integer.compare(o1.age, o2.age); // Integer 클래스에 정의된 compare 함수로 두 정수 값을 비교
            }
        });
        ...
        Arrays.sort(users, new Comparator<User>() {
            @Override
            public int compare(User o1, User o2) {
                return o1.name.compareTo(o2.name); // compareTo() 사용
            }
        });
